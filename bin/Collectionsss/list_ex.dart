...
List <int> numbers = [10,20,21,23];

// NOTE : if you want to store specific type data then use List<datatype> listname   DO NOT USE var
...
l5[1] = 3;
l5[1] = 5;
///l5.add(10); cannot add to a fixed list since l5 has a intial value of growable = false


///6. List.generate
List l6 = List.generate(5, (index) => 8 * index+2);  //8 * 0 + 2   8 * 2 + 2 etc



//7. List.unmodifiable
List l7 = List.unmodifiable(l6);   // values from l6 added to l7
// l7.add(15); cannot add 
